...
export const areas =[
    {
        ...
        client: [
            {
                title: 'gravitypope',
                staticAsset: (<StaticImage src='../src/images/expertise/expertise-gravitypope.jpg' alt='gravitypope' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Sugarlash PRO',
                staticAsset: (<StaticImage src='../src/images/expertise/expertise-sugarlashpro.jpg' alt='Sugarlash PRO' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Helm',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-thehelm.jpg' alt='Helm Menswear' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Haven',
                staticAsset: (<StaticImage src='../src/images/expertise/expertise-haven.jpg' alt='Haven Menswear Canada' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Goldsquare',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-goldsquare.jpg' alt='goldsquare vision' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Fancii',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-fancii.jpg' alt='fancii website' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Healthy Bedroom',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-healthybedroom.jpg' alt='healthy bedrooom website' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Orijen',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-orijen.jpg' alt='Orijen image' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'SOHO Hair',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-sohohair.jpg' alt='soho hair salon' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Publish Brand',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-publishbrand.jpg' alt='Publish brand website' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Naked and Famous',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-nakedandfamous.jpg' alt='naked and famous demin' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Nalata Nalata',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-nalatanalata.jpg' alt='Nalata Nalata' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
        ]
    },
    {
        ...
        client: [
            {
                title: 'Uptop',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-uptop.jpg' alt='Uptop branding' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Farrow',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-farrow.jpg' alt='Farrow sandwiches' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Three Boars',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-threeboars.jpg' alt='Three Boars eatery' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'HighDough',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-highdough.jpg' alt='Highdough pizza' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Press’d',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-pressd.jpg' alt='Pressd sandwiches' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'North 53',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-north53.jpg' alt='North 53 cocktail place' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Wishbone',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-wishbone.jpg' alt='Wishbone restaurent' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Baiju',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-baiju.jpg' alt='Baiju restaurent' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Malt and Mortar',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-maltandmortar.jpg' alt='Malt and Mortar pub' width={300} placeholder='constrained' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            // {
            //     title: 'Vine arts',
            ...
            {
                title: 'DOSC',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-dosc.jpg' alt='DOSC restaurant' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
        ]
    },
    {
        ...
        client: [
            {
                title: 'KV Capital',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-kvcapital.jpg' alt='KV Capital' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Canada ICI',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-canadaici.jpg' alt='canada ici' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Epic Investment Services',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-epic.jpg' alt='epic investments corporation' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'HSBC Place',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-hsbc.jpg' alt='hsbc place edmonton' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Currents of Windermere',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-currentsofwindermere.jpg' alt='currents of windermere' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Beljan',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-beljan.jpg' alt='beljan developments company' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Hyphen Group',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-hyphen.jpg' alt='hyphen development group' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: '103 Street Center',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-103st.jpg' alt='103 street center' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'North District',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-northdistrict.jpg' alt='north district edmonton' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
        ]
    },
    {
        ...
        client: [
            {
                title: 'Maclean’s',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-macleans.jpg' alt='Maclean’s magazine' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Theater Network',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-theatrenetwork.jpg' alt='theater network edmonton' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Georgie Magazine',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-georgie.jpg' alt='georgie magazine' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Human Odyssey',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-humanodyssey.jpg' alt='the human odyssey' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Handful of Films',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-handfuloffilms.jpg' alt='handful of films' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            }
        ]
    },
    {
        ...
        client: [
            {
                ...
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-afpacampaign.jpg' alt='love alberta forests virtual reality tour' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Love AB Forests VR Tour',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-afpavr.jpg' alt='love alberta forests virtual reality tour' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'YEG City Budget',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-yegcitybudget.jpg' alt='the edmonton city budget' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Report to the City',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-reportothecity.jpg' alt='a report for hte city of edmonton' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Invest Alberta Corporation',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-iac.jpg' alt='invest alberta corporation' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Alberta Forest Products Association',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-afpacorp.jpg' alt='albert forestry products association' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'City of Leduc',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-cityofleduc.jpg' alt='the city of leduc' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            }
        ]
    },
    {
        ...
        client: [
            {
                title: 'HSEA',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-hsea.jpg' alt='Hodgson Schilf Evans Architects' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'holo-blok',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-holoblok.jpg' alt='holo-blok architecture' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            // {
            //     title: 'Vignettes',
            ...
            // },
            {
                ...
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-workungarrick.jpg' alt='Workun Garrick' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Green Impact Partners',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-gip.jpg' alt='Green Impact Partners' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Cure MD',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-curemd.jpg' alt='cure md' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'SMP',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-smp.jpg' alt='swainson mikki plesket law offices' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Mettra Pharmacy',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-mettra.jpg' alt='mettra pharmacy edmonton' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Pure Aligners',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-purealigners.jpg' alt='pure aligners' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            },
            {
                title: 'Hello Dental',
                staticAsset :(<StaticImage src='../src/images/expertise/expertise-hellodental.jpg' alt='hello dental office' width={300} placeholder='blurred' layout='constrained' objectFit="contain" className='block-expertise_content-image'/>),
            }
        ]
    },
]
