...
export const caseStudies = [
    {
        ...
        image: (<StaticImage src='../src/images/ecomm/NalataEcomm.png' alt='Nalata nalata case study' layout='fullWidth' placeholder='blurred'/>),
        
    },
    {
        title: 'HAVEN – Shopify Plus + WordPress',
        link: '/work/haven',
        image: (<StaticImage src='../src/images/ecomm/HavenEcomm.png' alt='Haven Menswear Case study' layout='fullWidth' placeholder='blurred'/>),
    }
]

export const partners = [
    {
        image: (<StaticImage src='../src/images/clients/logo-haven.png' alt='Haven Menswear' layout='fullWidth' placeholder='blurred'/>),
    },
    {
        image: (<StaticImage src='../src/images/clients/logo-nalata-nalata.png' alt='Nalata nalata' layout='fullWidth' placeholder='blurred'/>),
    },
    {
        image: (<StaticImage src='../src/images/clients/tonal-logo-white.png' alt='Haven Menswear Case study' layout='fullWidth' placeholder='blurred'/>),
    }
]
